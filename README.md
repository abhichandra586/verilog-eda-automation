...
> A professional Python automation framework for VLSI RTL design projects. Wraps `iverilog` + `vvp` with compile, simulate, parse, report, watch, and Vivado parsing — all from a single CLI command.
...
| Role                                    | Contributor       |
|-----------------------------------------|-------------------|
| Framework design and implementation     | Sujeet Kona       |
| RTL project integration and module registry | Abhi Chandra B |
